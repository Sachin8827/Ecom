...
<html>
    ...
    // Send an AJAX request to the servlet to add the product to the cart
    $.ajax({
        type: "POST",
        url: "AddtoCart",
        data: { id: productId },
        success: function(response) {
            // Check if the addition was successful
                ...
                // Refresh the content of the cart12 element with the updated cart size
                $("#cart12").load(" #cart12");
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-4 col-sm-12 d-flex">
                    <form action='' id="log" method="post">
                        <input type="submit" name="logoutButton" value="Logout" class="btn btn-primary mt-4">
                        <%
                                
                             
                                if (request.getMethod().equalsIgnoreCase("POST")) {
                                    String s = request.getParameter("logoutButton");
                                    if (s != null && !s.isEmpty() && s.equals("Logout")) {
                    ...
                    <a href="Cart" id="cart12">
                         <i class="fas fa-shopping-cart position-relative mt-4 ms-5 fs-1" aria-hidden="true" >
            ...
            <div class="offcanvas-body text-center">
                <div class="mx-auto">  Center the table 
                    ...
                    <%
                        ...
                        ProductDAO pdao[] = (ProductDAO[]) session.getAttribute("product");
                        if (pdao != null) {
                    %>
                                ...
                                <% for (int i = 0; i < pdao.length; i++) { %>
                                    <div class="col-lg-4 col-md-6 col-sm-12 col-12 mt-5">
                                        <div class="card" style="width: 18rem;">
                                            ...
                                            <div class="card-body">
                                                <h5 class="card-title"><%= pdao[i].getProduct() %></h5>
                                                <p class="card-text"><%= pdao[i].getDiscription() %></p>
                                                <h5> Price : <%= pdao[i].getPrice() %></h5>
                                                <a href="#" class="btn btn-primary">Buy now</a>
                                                <button  class="btn btn-info" onclick="AddToCart(<%=pdao[i].getId()%>)">Add to Cart</button>
                                            </div>
                                        </div>
                                    </div>
                                <% } %>
